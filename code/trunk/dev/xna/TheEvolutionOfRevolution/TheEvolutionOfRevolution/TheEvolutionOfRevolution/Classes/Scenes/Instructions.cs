...
namespace TheEvolutionOfRevolution
{
    class Instructions : Scene
    {
        ...
        public override void LoadContent(ContentManager content)
        {
            ...
            this.btBackMenu = new Button(new Vector2(1300/2 - 200/2, 500), new Point(200, 50), content.Load<Texture2D>("Botoes//bt_menu"), content.Load<Texture2D>("Botoes//bthover_menu"));
